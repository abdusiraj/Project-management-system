          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Examinor Page /</span> Notifications
              </h4>
              ...
              <div class="row gy-3">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="table-responsive">
                     <?php
                     $sqqll=$con->query("SELECT * from `message` where `message_of`='examiner' and `to`='$group_id'");
...
<div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row gy-3">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="table-responsive">
                     <?php
                     $sqqll=$con->query("SELECT * from `message` where `message_of`='student' and `to`='examiner' and `from`='$group_id'");
