          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Advisor Page / </span> Connections
              </h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <tbody>
                   ...
                   $sql = "SELECT * FROM `project_group` where advisor_id='$adv_id' and `status`!='finshed'";
                   $run=$con->query($sql);
                 ...
                 <?php  }
                              ...
                              <div class="modal-body">
                                <div class="row">
                                  <div class="col mb-3">
                                    ...
                                    <?php 
                                    $sqq=$con->query("SELECT * from project_group where `advisor_id`='$adv_id' and `status`!='finshed'");
                                    $rr=$sqq->fetch_assoc();
                                    $group=$rr['group_id'];
                                    ...
                                    <label for="exampleInputMobile" class="col-sm-3 col-form-label">advisor mark 30%</label>
                                      <div class="col-sm-4">
                  ...
                  <tbody>
                   ...
                   $qq=$con->query("SELECT * from project_group where `advisor_id`='$adv_id' and `status`!='finshed'");
                   $tt=$qq->fetch_assoc();
                   $groupi=$tt['group_id'];
                   $sql2=$con->query("SELECT * from student st inner join result rs on st.stu_id=rs.stu_id where rs.group_no='$groupi'");
                   while($row=$sql2->fetch_assoc()){
                    ...
                    echo '<tr class="odd gradeX" id="rec">';
                     ?>
                                ...
                                <td> <?php echo $row['advisor_mark'];?></td>
