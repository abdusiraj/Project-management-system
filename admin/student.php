        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
              <div class="card">
              <a type="button" href="addstu.php" class="btn btn-primary text-white">Add</a>
                    ...
                    $email= $row['email'];?>
                      ...
                      <tr>
                        ...
                        <td><?php if($row2['status'] == 1): ?>
                            ...
                            <td>
                            <a rel="facebox" href="updatestu.php?Id=<?php echo $row['email']; ?>" class="btn btn-sm btn-info">Update</a><br>
