              ...
              <div class="layout-demo-wrapper">
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="addstupro.php" method="post" onsubmit='return formValidation()'>
                    ...
                    <div class="form-group row">
                      <label for="exampleInputPassword2" class="col-sm-4 col-form-label">CGPA</label>
                      <div class="col-sm-8">
                        <input type="text" name="cgpa" class="form-control" id="exampleInputPassword2" placeholder="Password">
                      </div>
                    </div>
