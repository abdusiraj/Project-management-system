                          ...
                          <div class="card-title d-flex align-items-start justify-content-between">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                <a class="dropdown-item" href="coordinator.php">View More</a>
                                
                              </div>
                            </div>
                          </div>
                          <span class="fw-semibold d-block mb-1">Coordinator</span>
                          <h3 class="card-title mb-2">
                          <?php 
                          include('../connection.php');
                          // $sql=$con->query("Select * from coordinator");
                          $result=$con->query("SELECT count(*) as total from coordinator");
                                 $data=$result->fetch_assoc();
                                 $percent = $data['total'];
                                echo "<p class='fs-30 mb-2'>"; echo $percent;   echo"</p>";
                          ?></h3>
                          ...
                          <div class="card-title d-flex align-items-start justify-content-between">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                                <a class="dropdown-item" href="exminer.php">View More</a>
                          ...
                          <div class="card-title d-flex align-items-start justify-content-between">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt4">
                                <a class="dropdown-item" href="advisor.php">View More</a>
                              
                              </div>
                            </div>
                          </div>
                          <span class="d-block mb-1">Advisor</span>
                          ...
                          <div class="card-title d-flex align-items-start justify-content-between">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="cardOpt1">
                                <a class="dropdown-item" href="student.php">View More</a>
