        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
              <div class="card">
              <a type="button" href="makegroup.php" class="btn btn-primary text-white">Add</a>
                    ...
                    $status= $row['status'];?>
                      ...
                      <tr>
                        ...
                        <td>    <?php if($row['status'] =="accept" ): ?>
                            ...
                            <td>
                            <a rel="facebox" href="managegroup.php?Id=<?php echo $row['group_id']; ?>" class="btn btn-sm btn-info">Manage</a><br>
