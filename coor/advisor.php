            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row gy-3">
                  ...
                  <div class="card mb-4">
                   ...
                   $sql = "SELECT * FROM `project_group` where advisor_id!=0 ";
                   $run=$con->query($sql);
                   while($row=$run->fetch_assoc()){
                    ...
                    $sql2=$con->query("SELECT * from advisor where adv_id='$advisor_id'");
                ...
                <div class="col gy-2">
                  <div class="col-md-12">
                  <div class="card mb-4">
                    <h5 class="card-header">Assign Advisor: </h5>
                    <div class="card-body">
                      <div>
                      <form action="assignadvisor.php" method="POST">
                              <div class="modal-body">
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="nameBasic" class="form-label">Select Advisor</label>
                                    <input
                                      type="hidden"
                                      name="id"
                                      value=""
                                    ...
                                    $sql3=$con->query("SELECT * from project_group where advisor_id=0 and `status`='accept'");
                                    $sql4=$con->query("SELECT * from advisor where `status`='free'");
                                    ?>
                                    <select name="adv_id" class="form-select" id="exampleFormControlSelect1" aria-label="Default select example">
                                        <option selected></option>
                                        <?php 
                                        while($row4=$sql4->fetch_assoc()){
                                        ?>
                                        <option value="<?php echo $row4['adv_id']; ?>"><?php echo $row4['fname']; echo " "; echo $row4['mname']; echo " "; echo $row4['lname'];?></option>
                                        <?php } ?>
                                    </select> <br>
